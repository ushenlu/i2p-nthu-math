...
int main(){
    ...
    cin >> a_sign ; a_sign = (a_sign>=0 ? 1 : -1) ;
    ...
    cin >> b_sign ; b_sign = (b_sign>=0 ? 1 : -1) ;
    ...
    int result = (a_sign*b_sign==-1 ? (a_sign>b_sign ? 1 : -1) : (a_exp>b_exp ? a_sign : (a_exp<b_exp ? -a_sign : (a_mantissa>b_mantissa ? a_sign :(a_mantissa<b_mantissa ? -a_sign : 0))))) ;
    cout << "Compare result: "
         << result
         << endl ;
