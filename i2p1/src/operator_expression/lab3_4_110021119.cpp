...
int main()
{
    ...
    std::cout << "The real number (a) is: " << man1 << "e" << std::showpos << expo1 << std::noshowpos << std::endl;
    std::cout << "The real number (b) is: " << man2 << "e" << std::showpos << expo2 << std::noshowpos << std::endl;
